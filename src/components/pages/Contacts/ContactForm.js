    ...
    return (
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6 w-full">
            <input
                ...
                className="col-span-2 w-full px-4 py-2 text-lg placeholder-gray-500 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
            />
            <input
                type="email"
                name="email"
